...
function logAccess($expr, $leadingzeros, $unique, $min, $max) {
	try {
		...
		$stmt->execute(['expr' => $expr, 'leadingzeros' => $leadingzeros, 'uniquevalues' => $unique, 
            ...
            <div class="col">
               <form id="alphameticsform" method="post" action="<?php echo htmlspecialchars(extractPath($_SERVER["PHP_SELF"]));?>">
					...
					<div class="form-check">
						...
						<input type="checkbox" class="form-check-input" value="leadingZero" name="leadingZero" <?php if ($leadingZero === "leadingZero") { echo "checked"; } ?>>
						Allow leading zeroes on operands?</label>
					</div>
                    <div class="form-check">
                        <label class="form-check-label">
                            <input type="radio" name="unique" class="form-check-input" value="unique" required <?php if ($unique == "unique") { echo "checked"; } ?> />
                            Generate unique values for each letter?
                        </label>
                    </div>
                    <div class="form-check">
                        <label class="form-check-label">
                            <input type="radio" name="unique" class="form-check-input" value="repeat" required <?php if ($unique == "repeat") { echo "checked"; } ?>>
